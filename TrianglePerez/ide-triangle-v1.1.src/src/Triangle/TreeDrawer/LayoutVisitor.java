...
public class LayoutVisitor implements Visitor {
  ...
  public DrawingTree visitCaseExpression(CaseExpression ast, Object o) {
    DrawingTree t = layoutCaption("CaseExpression");
    DrawingTree vTree = (DrawingTree) ast.V.visit(this, null);
    t.setChildren(new DrawingTree[]{vTree});

    for (Object literal : ast.MAP.keySet()) {
      DrawingTree literalTree = layoutCaption(literal.toString() + " :");
      DrawingTree expressionTree = (DrawingTree) ast.MAP.get(literal).visit(this, null);
      literalTree.setChildren(new DrawingTree[]{expressionTree});
      t.setChildren(new DrawingTree[]{literalTree});
    }
